...
IInferRequestInternal::Ptr CLDNNExecNetwork::CreateInferRequest() {
    ...
    return std::make_shared<CLDNNAsyncInferRequest>(std::static_pointer_cast<CLDNNInferRequest>(internalRequest), m_taskExecutor, m_waitExecutor,
                                                       _callbackExecutor);
}
